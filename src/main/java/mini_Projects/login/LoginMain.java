...
public class LoginMain {
    ...
    menu: kullanıcıya işlem seçimi için menu gösterilir.
    ...
    gisiş (login): kullanıcı adı/email ve şifre girilir.
                        kullanıc adı veya email bulunamazsa, kayıtlı değil, üye olun uyarısı verilir.
                        kullanıc adı/email ile aynı indekste kayıtlı şifre dogrulanırsa siteye giriş yapılır.
