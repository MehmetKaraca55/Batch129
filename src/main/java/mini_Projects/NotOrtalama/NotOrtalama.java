package mini_Projects.NotOrtalama;
...
public class NotOrtalama {
    ...
    sistem ArithmeticException hatası versin ve "Notlar 0-100 arasında olmalı" mesajını dondürdün.
    Diger durumlarda ise, vizenin yüzde 40 ını, finalin yüzde 60 ını alsın toplasın.
