...
public class C01_StringManipulations {
     ...
     */
       ...
       3) \\s   ==> space tum bosluklar space
        ...
        System.out.println("Yüz" + (40+60));//Yüz100: Parantez önceliği var.
        System.out.println("ikiyüzkırk"+40*60);//ikiyüzkırk240: çarpmanın işlem önceliği var.
        System.out.println(60+40+"Yüz");//100Yüz

        // Kullanıcıdan ismini soyismini girmesini isteyin. Kullanıcı nasıl girerse girsin, tam isminin büyük harfle
        //yazılmasını sağlayın

        Scanner input=new Scanner(System.in);
        System.out.println("Lütfen isminizi ve soyisminizi giriniz");
        String isim = input.nextLine(), soyİsim = input.nextLine();//MUltiple Decleration
        ...
        cümle= cümle.replaceAll("\\w", "*") + cümle.substring(10);
        System.out.println(cümle);

        //"a" harfini "@" işareti ile değiştirin
        String ders= "olağanüstü";
        System.out.println(ders = ders.replace('a', '*'));
